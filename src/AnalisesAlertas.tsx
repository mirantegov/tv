...
export const AA: Record<string, Bloco> = {
	"/": {
		itens: [
			...
			{
				sev: "warn",
				titulo: "Educação (MDE) em 20,09% — abaixo do mínimo de 25%",
				det: "Aplicação acumulada até o mês 4 (parcial); o ritmo precisa acelerar para cumprir o piso constitucional (CF art. 212) no fechamento do exercício.",
			},
			{
				sev: "warn",
				titulo: "3 obras paralisadas (R$ 1,12 mi)",
				det: "Obras paradas são apontamento recorrente do TCE-PR — retomar a execução ou formalizar o encerramento com justificativa.",
			},
			{
				sev: "info",
				titulo: "Execução equilibrada até 5/2026",
				det: "Receita arrecadada em 41,5% da previsão atualizada e despesa empenhada em 41,9% da dotação — ritmos aderentes para o mês 5.",
			},
			{
				sev: "info",
				titulo: "Folga de 12 p.p. no limite de pessoal (LRF)",
				det: "Despesa de pessoal em 41,98% da RCL (R$ 118,4 mi) ante o teto de 54% — margem confortável para o Executivo.",
			},
			{
				sev: "info",
				titulo: "Dívida Consolidada Líquida negativa (−39,38%)",
				det: "Haveres superam a dívida; município sem pressão de endividamento e com operações de crédito zeradas no exercício.",
			},
			{
				sev: "info",
				titulo: "27 processos em trâmite no TCE-PR",
				det: "22 em Unidades Instrutivas e 5 em Gabinetes de Relator — acompanhar os prazos de manifestação.",
			},
		],
		emDia: [
			["Pessoal 41,98%", "teto 54% ✓"],
			["Saúde 25,62%", "mín. 15% ✓"],
			["Dívida −39,38%", "teto 120% ✓"],
			["Op. crédito 0%", "teto 16% ✓"],
		],
	},
	"/panorama": {
		itens: [
	...
	"/despesa": {
		...
		emDia: [["Liquidado 87,3%", "do empenhado ✓"]],
	},
	"/despesa-comp": {
		itens: [
			{
	...
	"/tce": {
		itens: [
			...
			{
				sev: "info",
				titulo: "Agenda de Obrigações sem itens não atendidos",
				det: "18 obrigações em dia e nenhuma pendência entre as 3 entidades; 6 itens não aplicáveis ao ente.",
				href: "/tce",
			},
		],
		emDia: [
	...
	"/siconfi": {
		itens: [
			...
			{
				sev: "info",
				titulo: "Aplicações mínimas acima do piso",
				det: "Educação em 26,06% (mín. 25%) e Fundeb — profissionais da educação em 88,62% (mín. 70%); limites de crédito, PPP e VAAT também regulares.",
				href: "/siconfi",
			},
		],
		emDia: [
			["CAUC", "situação regular ✓"],
			["Educação e Fundeb", "acima do piso ✓"],
			["Precatórios / CADIN / previdência", "adimplente ✓"],
		],
	},
	"/financeiro-analises": {
		itens: [
